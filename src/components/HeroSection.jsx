...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      aria-label="Hero Section with latest magazines and navigation buttons"
    >
      ...
      <div className="relative z-20 flex flex-col md:flex-row items-center justify-center gap-8 max-w-5xl w-full px-4 sm:px-6 py-6 sm:py-10 text-center md:text-left bg-black bg-opacity-30 rounded-xl shadow-xl backdrop-blur-md border border-white/10">
        ...
        <div className="relative flex items-center justify-center">
          <a href="/reader/1" className="relative block transform -rotate-12 -translate-y-2 -mr-12">
            <img src={udgave1} alt="Magazine Issue 1" className="w-36 sm:w-48 md:w-56 rounded-lg shadow-2xl ring-2 ring-white/20 transition-transform duration-300 hover:scale-110 hover:z-20" />
          </a>
          <a href="/reader/2" className="relative z-10 block transform rotate-2 translate-y-3">
            <img src={udgave2} alt="Magazine Issue 2" className="w-40 sm:w-52 md:w-60 rounded-lg shadow-2xl ring-2 ring-white/30 transition-transform duration-300 hover:scale-110 hover:z-20" />
          </a>
          <a href="/reader/3" className="relative block transform rotate-10 -translate-y-4 -ml-12">
            <img src={udgave3} alt="Magazine Issue 3" className="w-36 sm:w-48 md:w-56 rounded-lg shadow-2xl ring-2 ring-white/20 transition-transform duration-300 hover:scale-110 hover:z-20" />
          </a>
        </div>
